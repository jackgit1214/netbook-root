...
const initialDataState = {
    ...
    columnTitles: [
        {id: 'crawlerUrl', label: 'URL地址',minWidth: 120,width:350,
            align: 'center',
            dataAlign:"left",
            format:value=>{return (<LinesEllipsis text={value} maxLine={1} winWidth={200}
        ...
        },
        {
            ...
            align: 'center',
            dataAlign: 'left',
            format: value => {let time  = new Date(value);
            return time.toLocaleDateString("cn",{ year: 'numeric', month: 'numeric', day: 'numeric',hour: 'numeric', minute: 'numeric', second: 'numeric',hour12: false})}
        },
        {
            id: 'urlContent',
            label: '内容',
            align: 'center',
            dataAlign: 'left',
            format:value=>{return (<div style={{ width: 500, whiteSpace: 'nowrap' }}><Box
    ...
    switch (action.type) {
        ...
        case actionType.PAGE_HANDLE:
        {
           ...
           // let handleTotalNumber=action.params.otherParams.ids.length; //记录总数量
            return Object.assign({}, state, {actionLoading:tmpLoad11,handleState:tmpHandleState,handleNumber:0 ,code:0,message:"",});
        }
        ...
        case actionType.REFRESH_PAGE: {
            ...
            return Object.assign({}, state, {actionLoading:actionLoading,loading:true,code:action.code,dataRecords: dataList,pageInfo:tmpPage});
        }
        case actionType.PAGE_RESPONSE:{
            let tmpResult = action.result;
            let tmpLoad = state.actionLoading;
            tmpLoad[tmpResult.id]=false;
            return Object.assign({}, state, {actionLoading: tmpLoad,code:tmpResult.code ,message:tmpResult.message,errorInfo:tmpResult.errorInfo});
        }
