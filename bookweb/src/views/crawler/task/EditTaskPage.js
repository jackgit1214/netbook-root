...
function EditDialog(props) {
    ...
    return (
        <Dialog open={dialogStatus} onClose={handleClose} classes={{paper: classes.dialogPaper}}
                disableBackdropClick={true}
                disableEscapeKeyDown={true} maxWidth={"sm"} PaperComponent={PaperComponent}
                aria-labelledby="form-dialog-title">
            <DialogTitle classes={{root: classes.dialogTitle}} id={'taskDialog' + dialogId}
                         style={{cursor: 'move'}}>编辑抓取任务</DialogTitle>
            <Formik
                            ...
                            <Grid container>
                                ...
                                <Grid item xs={4} className={classes.gridItem}>
                                    ...
                                    >
                                        ...
                                        <MenuItem classes={{root: classes.menuItemRoot}} key={2}
                                                  value={2}>部分网页</MenuItem>
                                    </Field>
                                </Grid>
                                <Grid item xs={4} className={classes.gridItem}>
                                    <Field
                                ...
                                <Grid item xs={4} className={classes.gridItem}>
                                    <Field
                                        ...
                                        margin="dense"
                                    >
                                        <MenuItem classes={{root: classes.menuItemRoot}} key={0}
                                                  value={0}>未开始</MenuItem>
                                        <MenuItem classes={{root: classes.menuItemRoot}} key={1}
                                                  value={1}>进行中</MenuItem>
                                        <MenuItem classes={{root: classes.menuItemRoot}} key={2}
                                                  value={2}>已完成</MenuItem>
                                    </Field>
                                </Grid>
                            </Grid>
                            <Divider variant="middle" classes={{middle: classes.divideMiddle}}
                                     style={{display: clsx(task ? "" : "none")}}/>
